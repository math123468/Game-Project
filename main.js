...
var problems = [['How many columns are in a 3x5 matrix?','How many rows are in a 3x5 matrix?','What are the dimensions of [4 5 5;2 1 9]?',
		...
		'T/F:All elementary row operations are reversible','T/F:Matrix multiplication is commutative','T/F:Matrix multiplication is associative',
		 'T/F: All matrix transformations are linear','T/F: Matrix multiplication is left AND right distributive','What is the determinant of [1 4;-2 1]?',
		'What is the determinant of [3 -1;1 4]?','T/F: The determinant of a triangular matrix is the product of the entries on the main diagonal','T/F: Elementary row operations do not change the determinant',
		'T/F: The area of a parallelogram determined by the columns of a 2x2 matrix is the absolute value of the determinant of said matrix',
		 'T/F: The Null space of a matrix is always a vector space','How many dimensions does R5 have?'],
		...
		'Is the transformation with matrix [1 3 -2 4;-5 1 -2 2;-1 -1 -1 7] one to one? y/n','T/F: (AB)^-1 = A^-1B^-1','What is the determinant of [1 5 0;2 4 -1;0 -2 0]?',
		'T/F: The area of a parallelopiped determined by the columns of a 3x3 matrix is always the determinant of said matrix','Is the set {[1;2;3],[9;8;7]} a basis for R3? y/n'],
		['What is the inverse of [3 4;4 5]?','Solve the equation [1 0 -2;-2 1 6;3 -2 -5]x = [-1;7;-3]','What is the inverse of [4 9;3 7]?',
		 ...
		 'What is the rref of [1 2 3 4;4 5 6 7;6 7 8 9]?','What is the determinant of [1 -3 1 -2;2 -5 -1 -2;0 -4 5 1;-3 10 -6 8]?','T/F: R2 is a subspace of R3',
		 'T/F: All vector spaces have an integer number of dimensions'],
...
var solutions = [['5','3','2x3','y','n','y','n','y','[1 1 3;3 2 -1;-2 -1 2]','[4 -1 3 -7;-3 -2 1 -1;-2 4 -1 4]','B','T','F','T','T','T','9','13','T','F','T','T','5'],
		 ['[42 35;54 44]','A','B','2','F','y','n','n','F','-2','F','n'],
		 ['[-5 4;4 -3]','[3;1;2]','[7 -9;-3 4]','[0;-3;1]','n','[1 0 -1 -2;0 1 2 3;0 0 0 0]','0','F','F'],
